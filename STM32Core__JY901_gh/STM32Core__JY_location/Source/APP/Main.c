...
int16_t txx = 0;//double txx = 0;
int16_t tyy = 0;//double tyy = 0;
...
int main(void)
{
    ...
    //    sprintf(str, "Angle:%.3f %.3f %.3f\r\n", (float)stcAngle.Angle[0] / 32768 * 180, (float)stcAngle.Angle[1] / 32768 * 180, (float)stcAngle.Angle[2] / 32768 * 180);
     //   UART1_Put_String(str);
				...
				delay_ms(10);
		//	xl =xx*cos((float)stcAngle.Angle[2] / 32768 *3.1415926)-yy*sin((float)stcAngle.Angle[2] / 32768 *3.1415926);//cos(str+0);//str[3] = {11,22,33}
	//		yl =yy*cos((float)stcAngle.Angle[2] / 32768 *3.1415926)+xx*sin((float)stcAngle.Angle[2] / 32768 *3.1415926);
        UART1_Put_Char('x');
        UART1_Put_Char(':');
	
			xx = TIM4->CNT; 
        if(xx < 0)      //用xl换xx，赶紧上机验证
        {
            txx = -xx;
            UART1_Put_Char('-');
        }
        ...
        UART1_Put_Char((long int)(txx*CIRCUM/N) / 10000 % 10 + 48);//    (long int)(txx)/10000000000%10+48;
        UART1_Put_Char((long int)(txx*CIRCUM/N) / 1000 % 10 + 48);
        UART1_Put_Char((long int)(txx*CIRCUM/N) / 100 % 10 + 48);
        UART1_Put_Char((long int)(txx*CIRCUM/N) / 10 % 10 + 48);
        UART1_Put_Char((long int)(txx*CIRCUM/N) % 10 + 48);
        UART1_Put_Char(0x0d);
        UART1_Put_Char(0x0a);
        ...
        UART1_Put_Char((long int)(tyy*CIRCUM/N) / 10000 % 10 + 48);
        UART1_Put_Char((long int)(tyy*CIRCUM/N) / 1000 % 10 + 48);
        UART1_Put_Char((long int)(tyy*CIRCUM/N) / 100 % 10 + 48);
        UART1_Put_Char((long int)(tyy*CIRCUM/N) / 10 % 10 + 48);
        UART1_Put_Char((long int)(tyy*CIRCUM/N) % 10 + 48);
        UART1_Put_Char(0x0d);
        UART1_Put_Char(0x0a);
